...
const DEFAULT_PUBLIC_UI_CONFIG = {
  ...
  selector: {
    ...
    cards: [
      ...
      { id: "library-pass", enabled: true, locked: false, lockMessage: "", title: "Library Night Pass", subtitle: "2 pass categories", description: "", destination: "https://campusconnect.thapar.edu/permissions/", features: ["Overnight Study Access", "Research & Project Work", "Barcode Scanning", "Digital Pass on Mobile"], order: 3 },
      ...
      { id: "community-feedback", enabled: true, locked: false, lockMessage: "", title: "Student Notices", subtitle: "Official campus communication", description: "Find official announcements, circulars and important updates from departments across TIET.", destination: "/student-notices", icon: "Megaphone", features: [], order: 6 },

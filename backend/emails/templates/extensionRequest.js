  ...
  return masterTemplate({
    ...
    content: `
      ...
      <div style="background: #f1f5f9; padding: 15px; border-radius: 6px; margin: 15px 0;">
        ...
        <p style="margin: 4px 0;"><strong>Current Checkout:</strong> ${new Date(data.oldCheckout).toDateString()}</p>
        <p style="margin: 4px 0;"><strong>Requested Extension Until:</strong> ${new Date(data.requestedCheckout).toDateString()}</p>
      </div>

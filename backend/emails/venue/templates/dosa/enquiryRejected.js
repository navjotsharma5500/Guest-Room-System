...
export default function enquiryRejected(data) {
  return {
    ...
    html: venueMasterTemplate({
      ...
      <p>
        We regret to inform you that your venue enquiry has been <strong>rejected</strong> by the DoSA Office. 
      ...
      <ul style="padding-left:18px;margin-top:6px;text-align:left;">
        ...
        <li>You may contact the DoSA Office for further clarification or alternate bookings</li>

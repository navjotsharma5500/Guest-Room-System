...
import { 
  ...
  CheckCircle, Receipt, History, DollarSign
} from 'lucide-react';
...
const mockDefaulters = [
  {
    ...
    bills: [
      { billNumber: 'BILL-001', amount: 3000, date: '2024-01-10', status: 'unpaid' },
      { billNumber: 'BILL-002', amount: 2000, date: '2024-01-15', status: 'unpaid' }
    ]
  },
  {
    _id: '2',
    ...
    reportedStatus: 'reported',
    bills: [
      { billNumber: 'BILL-003', amount: 5000, date: '2023-12-25', status: 'unpaid' },
      { billNumber: 'BILL-004', amount: 3500, date: '2024-01-05', status: 'unpaid' }
    ]
  }
];

const DefaulterManagement = ({ currentUser, onClose, onOpenPaymentModal }) => {
  ...
  return (
    <AnimatePresence>
      ...
      >
        <motion.div
          className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-3xl w-full max-w-7xl max-h-[95vh] overflow-hidden shadow-2xl border-4 border-red-500"
          initial={{ scale: 0.9, y: 20 }}
          animate={{ scale: 1, y: 0 }}
          exit={{ scale: 0.9, y: 20 }}
        >
          {/* Header */}
          <div className="bg-gradient-to-r from-gray-800 via-gray-900 to-black text-white p-6 border-b-4 border-yellow-500">
          ...
          {filteredDefaulters.length > itemsPerPage && (
            <div className="p-6 bg-white border-t-2 border-gray-200 flex justify-between items-center">

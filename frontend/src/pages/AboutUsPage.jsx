...
───────────────────────────────────────── */
const FEATURES = [
  { icon: Building2, label: "Guest Room Booking",   status: "Live",         color: "#fce8e8", ic: "#c62828", working: "A simple and efficient app that allows students, faculty, and staff at Thapar Institute to book guest rooms for visitors. Users can fill in guest details, select room preferences, and choose stay dates with ease. The system automatically checks availability and prevents booking conflicts, ensuring a smooth experience. You can track booking status, upload required documents, and view payment details directly from your dashboard. Administrators review and approve requests while keeping all stakeholders informed through email notifications. Your personal dashboard shows all your bookings, their status, and history in one place. Sign in securely using your Thapar email ID." },
  { icon: Calendar,  label: "Event Venue Booking",  status: "Live",         color: "#e3eeff", ic: "#1a56db", working: "A convenient platform for booking event venues within Thapar Institute for academic and extracurricular activities. Users can request spaces by selecting venue type, date, time, and event details in a structured form. The system ensures no overlapping bookings and maintains proper scheduling across all venues. Once submitted, requests go through an approval workflow managed by authorities. Users receive updates and confirmations via email. The dashboard provides a clear overview of all requested, approved, or rejected bookings. This ensures transparency and efficient coordination for organizing events on campus. Sign in securely using your Thapar email ID." },
  { icon: BookOpen,  label: "Event Calendar",       status: "Live",         color: "#e6f9f0", ic: "#0d7a4e", working: "A centralized digital calendar that keeps the Thapar Institute community informed about all upcoming events, bookings, and important schedules. Users can browse events by date, category, or venue, making it easy to stay updated on campus activities. The calendar reflects real-time data from approved bookings, ensuring accuracy and avoiding scheduling conflicts. Whether it's academic sessions, cultural events, or official meetings, everything is visible in one place. This helps students and staff plan better and stay engaged with campus life. Access your personalized view and stay informed at all times. Sign in securely using your Thapar email ID." },
  { icon: Moon,      label: "Library Night Pass",   status: "Live",         color: "#f0ecff", ic: "#6d28d9", working: "A dedicated app that enables students to request permission for late-night access to the Thapar Institute library. Users can submit requests by selecting date and duration, along with necessary details for approval. The system follows a structured approval process and ensures proper tracking of entries and exits. Once approved, students can use their pass for seamless access while maintaining campus safety protocols. Notifications and updates are shared via email for transparency. Your dashboard allows you to track all requests and their status in real time. Sign in securely using your Thapar email ID." },
  { icon: Sparkles,  label: "Society Night Pass",   status: "Coming Soon",  color: "#fff8e1", ic: "#b45309", working: "An organized platform for students involved in societies at Thapar Institute to request late-night permissions for events, practices, or official activities. Users can submit detailed requests including purpose, timing, and participant information. The system ensures all requests go through an approval workflow to maintain discipline and security on campus. Once approved, the pass allows smooth coordination between students and authorities. Users receive timely updates and notifications via email. The dashboard provides a complete overview of all submitted requests and their current status. Sign in securely using your Thapar email ID." },
  { icon: Search,    label: "Lost & Found",         status: "Live",         color: "#fff3e0", ic: "#c2410c", working: "A user-friendly app that helps students at Thapar find their lost items and return found belongings to owners. Anyone can browse items that have been turned in, search by category and location, and check recent additions anytime. If you find something that might be yours, you can claim it by describing how you lost it. You'll immediately see if your claim is approved. If you lose something, you can file a report with photos and details. The support team reviews claims, approves matches between lost reports and found items, and contacts everyone involved via email. Your personal dashboard shows all your activity—what you've found, what you're looking for, and current status of your claims. Sign in securely using your thapar email id." },
];

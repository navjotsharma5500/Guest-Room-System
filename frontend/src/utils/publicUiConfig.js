...
export const DEFAULT_PUBLIC_UI_CONFIG = {
  ...
  selector: {
    ...
    cards: [
      ...
      { id: "library-pass", enabled: true, locked: false, lockMessage: "", title: "Library Night Pass", subtitle: "2 pass categories", description: "", destination: "https://campusconnect.thapar.edu/permissions/", icon: "moon", badge: "", comingSoon: false, accentColor: "#6d28d9", cardColor: "#ffffff", features: ["Overnight Study Access", "Research & Project Work", "Barcode Scanning", "Digital Pass on Mobile"], order: 3 },

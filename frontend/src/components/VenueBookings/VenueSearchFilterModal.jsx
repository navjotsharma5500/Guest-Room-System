// src/components/VenueBookings/VenueSearchFilterModal.jsx - FIXED VERSION
import React, { useState, useMemo } from "react";
import { motion, AnimatePresence } from "framer-motion";
import { X, Search, Filter, Calendar, MapPin, User, Mail } from "lucide-react";
import { useEscapeKey } from "../../hooks/useEscapeKey";

export default function VenueSearchFilterModal({ theme, hallData, venueData, onClose }) {
  ...
  }, [hallData, venueData, searchTerm, selectedHall, selectedStatus, dateFrom, dateTo]);
  ...
  const halls = Object.keys(venueData || hallData || {});
  const statuses = [
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      ...
                      <div className="grid grid-cols-2 gap-4 text-sm">
                        ...
                        <div>
                          <p className={`${theme === "dark" ? "text-gray-400" : "text-gray-600"}`}>
                            Venue: <span className="font-medium text-white">{booking.hall} - Room {booking.roomNo}</span>
                          </p>
                          <p className={`${theme === "dark" ? "text-gray-400" : "text-gray-600"}`}>

...
export default function PaymentSection({ b, theme, onPay }) {
  ...
  // BUT HIDE if cancelled
  const shouldShowButton = !isCancelled && 
                          !isDepartmentPayment && 
                          paymentType !== "Free" && 
  ...
  if (isCancelled) {
    realPaymentStatus = "CANCELLED";
  } else if (realBalanceAmount <= 0 && paidAmount > 0) {
  ...
  useEffect(() => {
    // Debug logging
    console.log("PAYMENT SECTION:", { id: b._id, status: b.status, isCancelled, shouldShowButton });
  }, [b, isCancelled, shouldShowButton]);
      ...
      <div className="col-span-2">
        ...
        <div className="flex items-center gap-4 flex-wrap">
          ...
          >
            ...
            {realPaymentStatus === "CANCELLED" && `🚫 Cancelled (₹${totalAmount.toLocaleString()})`}
          </span>
        </div>

        {/* Department Payment Card */}
        {isDepartmentPayment && realBalanceAmount > 0 && !isCancelled && (
        ...
        {/* Regular Payment Breakdown - Only if NOT cancelled */}
        {!isDepartmentPayment && realBalanceAmount > 0 && !isCancelled && (
        ...
        {isCancelled && (
          <div className="mt-3 p-4 bg-red-50 border border-red-200 rounded-lg">
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1">
                <p className="text-red-900 font-bold text-lg">🚫 Cancelled Payment</p>
        ...
        {realBalanceAmount <= 0 && totalAmount > 0 && paidAmount > 0 && !isCancelled && (

...
export default function HallBookingsLayout({ theme, onBackHome, children }) {
  return (
    <div
    ...
    >
      ...
      >
        ...
        <motion.div
          ...
          className={`flex justify-between items-center px-6 py-4 border-b shadow-sm sticky top-0 z-30 backdrop-blur-md ${
            theme === "dark"
        ...
        >
          ...
          >
            <Users /> Common Hall Booking Portal
          </motion.h1>
